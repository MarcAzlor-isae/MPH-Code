...
# ---------------------------  USER‑CONFIGURABLE  --------------------------- #
DATA_DIR            = Path("c:/Users/marca/Documents/MAE/Research Project/3. Code/ml//xdf_recordings")   # folder containing *.xdf files
OUTPUT_FEATURE_CSV  = Path("features_matb5s.csv")
fs_new              = 256                        # resample rate (Hz)
epoch_length_sec    = 5.0                        # epoch duration (s)
